...
export const projectsData = {
  ...
  assistant: {
    title: "Assistant",
    subtitle: "A modern AI chat assistant for conversation, workflow, and diagramming tasks",
    description: `The app is a modern AI chat assistant with persistent chat history, file upload, AI-powered flowchart creation and editing, web search integration, and a highly interactive UI. It’s designed for both conversational AI and visual workflow/diagramming tasks.`,
    logo: {
      type: "svg",
    ...
    features: [
      {
        name: 'Chat with AI',
        description: 'Start new chats, continue previous sessions, and revisit chat history. All messages and AI responses are saved and accessible.',
        video: assistantVid1,
      },
      {
        name: 'File Upload & Inline Data',
        description: 'Upload images or files, preview them inline, and reference them in chat. The AI can process and respond to uploaded files.',
        video: assistantVid2,
      },
      {
        name: 'Flowchart Generation & Editing',
        description: 'Ask the AI to generate or modify flowcharts. Includes a visual editor with drag-and-drop, node management, and undo/redo.',
        video: assistantVid3,
      },
      {
        name: 'Web Search Mode',
        description: 'Enable web search to enhance answers. UI shows when search is active.',
        video: assistantVid4,
      },
      {
        name: 'Sidebar & Navigation',
        description: 'Access previous chats, start new ones, view user info, and collapse the sidebar for more workspace.',
        video: assistantVid1,
      },
      {
        name: 'Animated & Modern UI',
        description: 'Smooth motion animations, a friendly welcome screen, and a beautiful, modern interface.',
        video: assistantVid2,
      },
      {
        name: 'Chat Title Generation',
        description: 'AI generates a title for each chat session automatically.',
        video: assistantVid3,
      },
    ],
    tech: {
