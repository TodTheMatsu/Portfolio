    ...
    >
      ...
      >
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="xl:max-w-[50%] max-w-full h-max py-12 flex-grow bg-black/30 backdrop-blur-xl rounded-2xl border border-white/10 px-8 md:px-12 flex flex-col justify-start items-center space-y-0"
        >
          {/* Logo and Heading */}
          <motion.div 
