      ...
      <motion.div onClick={handleClick} className="w-full h-full flex justify-center overflow-auto py-28 space-x-5 md:px-20 px-5 scroll-smooth">
        ...
        >
          <div className='mx-auto flex flex-row justify-start items-center'>
            <svg fill="none" xmlns="http://www.w3.org/2000/svg" className=" stroke-white h-auto w-[10vw] mb-10" viewBox="0 0 20 20">
            ...
            <svg fill="none" xmlns="http://www.w3.org/2000/svg" className=" stroke-white absolute h-auto w-[10vw] mb-10 blur-md" viewBox="0 0 20 20">
          ...
          <motion.h1 variants={textVariants} className="text-white 2xl:text-9xl text-7xl font-sans font-thin text-center rounded-3xl pb-5">
            Assistant
          </motion.h1></div>
          ...
          <motion.a whileHover={{ scale: 1.1, transition: { duration: 0.2} }} className="text-white  backdrop-blur-md font-sans font-thin mx-auto text-center rounded-3xl px-2 outline pb-2 text-2xl"
           target="_blank"  href='https://assistant-c08b.onrender.com/' variants={textVariants}>Try it out</motion.a>
        ...
        <motion.div className="xl:w-[200px] xl:right-[15%] xl:top-[20%] top-0  xl:bg-black bg-white bg-opacity-20  xl:bg-opacity-20 rounded-3xl flex xl:flex-col flex-row px-5 gap-5 py-2 justify-center items-center fixed backdrop-blur-xl">
