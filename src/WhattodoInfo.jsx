    ...
    >
      <motion.div onClick={handleClick} className="w-full h-full flex justify-center overflow-auto py-28 space-x-5 px-20 scroll-smooth">
        ...
        >
          ...
          <motion.h1 variants={textVariants} className="text-white font-sans font-thin mx-auto text-center rounded-3xl px-2 outline-dashed pb-2 text-4xl">
            Introduction
          </motion.h1>
        ...
        <motion.div className="w-[200px] right-[15%] bg-white bg-opacity-20 rounded-3xl flex flex-col gap-5 py-5 justify-center items-center fixed backdrop-blur-md">
          {['Introduction', 'Features', 'Functions'].map((section) => (
            <motion.h1 key={section} className="text-white font-sans font-thin mx-auto text-center w-full text-2xl cursor-pointer">
              {section}
            </motion.h1>
          ))}
        </motion.div>
